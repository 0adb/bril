 ...
 *
 * Describes the shape and types of all the ingredients for a Bril2 operation
 ...
 */
export type Signature = BaseSignature<bril2.Type>;
...
/**
 * Like bril2.Type, except that type variables may occur at the leaves.
 */
export type PolyType = bril2.PrimType | TVar | {"ptr": PolyType};
...
export interface FuncType {
   ...
   */
  ret: bril2.Type | undefined,
}

/**
 * Type signatures for the Bril2 operations we know.
 */
